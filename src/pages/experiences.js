      ...
      <div ref={experiencesRef} className="relative bg-gray-900 text-white min-h-screen">
        ...
        <h2 className="text-center text-3xl p-8 mb-12">
          ...
          <div className="w-full md:w-1/2 px-12 mb-12">
            ...
            <ul className="list-disc ml-5">
              <li>
                Travail à l'expédition des fruits (pêches, nectarines,
                abricots).
              </li>
          ...
          <div className="w-full md:w-1/2 px-12 mb-12">
            ...
            <ul className="list-disc ml-5">
              <li>
                Manutention de charges lourdes (meubles, électroménager,
                cartons, etc.).
              </li>
          ...
          <div className="w-full md:w-1/2 px-12 mb-12">
            ...
            <ul className="list-disc ml-5">
              <li>
                Réparation de divers composants de smartphone, ainsi
          ...
          <div className="w-full md:w-1/2 px-12 mb-12">
            ...
            <ul className="list-disc ml-5">
              ...
              <li>
                Réalisation de plusieurs maintenances sur ces équipements.
              </li>
            </ul>
          </div>
