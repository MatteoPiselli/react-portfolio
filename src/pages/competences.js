...
import mongoDB from "../assets/images/competences/MongoDB.png";
...
import next from "../assets/images/competences/Next.js.png";
import express from "../assets/images/competences/Express.png";
  ...
  return (
    <ImageLoader>
      <div ref={competencesRef} className="relative bg-gray-900 text-white">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8 ml-[10%] mr-[10%] ">
