          ...
          <div className="relative w-[90%] md:w-[25%] h-auto m-8 transform transition-transform duration-300 hover:scale-105">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-75 flex items-center justify-center rounded-lg opacity-0 hover:opacity-100 transition-opacity duration-300">
              <div className="p-4 text-center">
                ...
                <p className="text-sm">
                  J'ai développé un projet de recherche de joueurs basé sur
                  l'API League of Legends de Riot Games, en prenant{" "}
                  <a
            ...
            <div className="absolute inset-0 bg-black bg-opacity-75 flex items-center justify-center rounded-lg opacity-0 hover:opacity-100 transition-opacity duration-300">
              <div className="p-4 text-center">
                ...
                <p className="text-sm">
                  ...
                  <strong>Tailwind CSS</strong>, car il est simple
                  d'utilisation.
                  <br />
            ...
            <div className="absolute inset-0 bg-black bg-opacity-75 flex items-center justify-center rounded-lg opacity-0 hover:opacity-100 transition-opacity duration-300">
              <div className="p-4 text-center">
                ...
                <p className="text-sm">
                  ...
                  <br />
                  <u>Stack Technique :</u>{" "}
                  <strong>HTML, CSS, PHP, MySQL</strong>.
                </p>
              </div>
            </div>
          </div>
